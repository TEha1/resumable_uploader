...
(function () {
    ...
    var Resumable = function (opts) {
        ...
        var onDrop = function (e) {
            ...
            //handle dropped things as items if we can (this letms us deal with folders nicer in some cases)
        ...
        var appendFilesFromFileList = function (fileList, event) {
            ...
            var errorCount = 0;
            var o = $.getOpt(['maxFiles', 'minFileSize', 'maxFileSize', 'maxFilesErrorCallback',
                'minFileSizeErrorCallback', 'maxFileSizeErrorCallback', 'fileType', 'fileTypeErrorCallback']);
                ...
                if (o.fileType.length > 0) {
                    ...
                    for (var index in o.fileType) {
                        ...
                        if ((fileName.substr(-1 * extension.length).toLowerCase() === extension) ||
                            //If MIME type, check for wildcard or if extension matches the files filetype
                            (extension.indexOf('/') !== -1 && (
